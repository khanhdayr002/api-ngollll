     ...
     // console.log(dataJson)
        ...
        if (dataJson.streamingData.adaptiveFormats[0].signatureCipher) {
            axios.get('https://www.youtube.com' + jsLink).then(async (i2) => {
              ...
              var data = await ytdl.getInfo('https://www.youtube.com/watch?v='+ VideoId)
  var link = data.player_response.streamingData.adaptiveFormats//[0].url
              ...
              //    console.log(sig + '\n' + decodeSignature(sig[1]))
                    ...
                    i.url = link// decodeURIComponent(url[1] + '&sig=' + decodeSignature(sig[1]));
                    return i
                })
                return resolveFunc({
                    statut: true,
